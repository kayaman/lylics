import { A as AstroError, E as ExpectedImage, L as LocalImageUsedWrongly, M as MissingImageDimension, U as UnsupportedImageFormat, I as IncompatibleDescriptorOptions, a as UnsupportedImageConversion, b as MissingSharp } from "../astro_CKbA4atV.mjs";
let DEFAULT_HASH_PROPS, isESMImportedImage, isLocalService, isRemotePath, isRemoteAllowed, appendForwardSlash, fileExtension, collapseDuplicateSlashes, sharp$1, isRemoteImage, joinPaths, prependForwardSlash, removeTrailingForwardSlash, slash, trimSlashes, __tla;
let __tla = (async ()=>{
    __tla = (async ()=>{
        ...
        collapseDuplicateSlashes = function(path) {
        ...
        isESMImportedImage = function(src) {
            return typeof src === "object";
        };
        isRemoteImage = function(src) {
        ...
        isLocalService = function(service) {
            if (!service) {
                return false;
            }
        ...
        const sharpService = {
            ...
            async transform (inputBuffer, transformOptions, config) {
                ...
                if (transform.format === "svg") return {
                    data: inputBuffer,
                    format: "svg"
                };
        ...
        sharp$1 = Object.freeze(Object.defineProperty({
            __proto__: null,
