...
import { l as levels, g as getEventPrefix, L as Logger, A as AstroIntegrationLogger, manifest } from "./manifest_BWqi-Jnv.mjs";
import { A as AstroError, R as ResponseSentError, l as MiddlewareNoDataOrNextCalled, n as MiddlewareNotAResponse, o as ROUTE_TYPE_HEADER, p as REROUTE_DIRECTIVE_HEADER, G as GetStaticPathsRequired, q as InvalidGetStaticPathsReturn, t as InvalidGetStaticPathsEntry, u as GetStaticPathsExpectedParams, v as GetStaticPathsInvalidRouteParam, P as PageNumberParamNotFound, D as DEFAULT_404_COMPONENT, N as NoMatchingStaticPathFound, w as PrerenderDynamicEndpointPathCollide, x as ReservedSlotName, y as renderSlotToString, z as renderJSX, B as chunkToString, C as LocalsNotAnObject, H as clientLocalsSymbol, J as clientAddressSymbol$1, K as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, O as ASTRO_VERSION, Q as responseSentSymbol$1, T as AstroResponseHeadersReassigned, V as renderEndpoint, W as renderPage, X as REROUTABLE_STATUS_CODES } from "./chunks/astro_CKbA4atV.mjs";
import { serialize, parse } from "cookie";
import { e as appendForwardSlash, j as joinPaths, t as trimSlashes, f as fileExtension, s as slash, p as prependForwardSlash, r as removeTrailingForwardSlash, g as collapseDuplicateSlashes, __tla as __tla_0, __tla as __tla_0 } from "./chunks/astro/assets-service_DnoFzrkN.mjs";
import "html-escaper";
import "clsx";
import "kleur/colors";
import "fast-glob";
...
let __astrojsSsrVirtualEntry, pageMap, __tla;
let __tla = Promise.all([
    ...
    __tla = Promise.all([
        ...
        function generatePaginateFunction(routeMatch) {
            return function paginateUtility(data, args = {}) {
                ...
                const result = [
                    ...
                    const current = correctIndexRoute(routeMatch.generate({
                        ...params
                    }));
                    const next = pageNum === lastPage ? void 0 : correctIndexRoute(routeMatch.generate({
                        ...params,
                        page: String(pageNum + 1)
                    }));
                    const prev = pageNum === 1 ? void 0 : correctIndexRoute(routeMatch.generate({
                        ...params,
        ...
        class RenderContext {
            ...
            static create({ locals = {}, middleware, pathname, pipeline, request, routeData, status = 200 }) {
            ...
            async render(componentInstance) {
                ...
                const lastNext = type === "endpoint" ? ()=>renderEndpoint(componentInstance, apiContext, serverLike, logger) : type === "redirect" ? ()=>renderRedirect(this) : type === "page" ? async ()=>{
                    ...
                    const response2 = await renderPage(result, componentInstance?.default, props, {}, streaming, routeData);
                    response2.headers.set(ROUTE_TYPE_HEADER, "page");
                    if (routeData.route === "/404" || routeData.route === "/500") {
                        response2.headers.set(REROUTE_DIRECTIVE_HEADER, "no");
                    }
                    return response2;
                } : type === "fallback" ? ()=>new Response(null, {
                        status: 500,
                        headers: {
        ...
        class AppPipeline extends Pipeline {
            static create({ logger, manifest, mode, renderers, resolve, serverLike, streaming }) {
        ...
        class App {
                ...
                if (this.#manifest.i18n && (this.#manifest.i18n.strategy === "domains-prefix-always" || this.#manifest.i18n.strategy === "domains-prefix-other-locales" || this.#manifest.i18n.strategy === "domains-prefix-always-no-redirect")) {
                    ...
                    if (host && protocol) {
                        ...
                        try {
                            ...
                            this.#logger.error("router", `Astro tried to parse ${protocol}//${host} as an URL, but it threw a parsing error. Check the X-Forwarded-Host and X-Forwarded-Proto headers.`);
            ...
            async #renderError(request, { locals, status, response: originalResponse, skipMiddleware = false }) {
                ...
                const response = this.#mergeResponses(new Response(null, {
                    status
                }), originalResponse);
                Reflect.set(response, responseSentSymbol$1, true);
                return response;
        ...
        const _page0 = ()=>import("./chunks/generic_CDmRHirH.mjs").then(async (m)=>{
                await m.__tla;
                return m;
            }).then(async (m)=>{
                await m.__tla;
        ...
        const _page1 = ()=>import("./chunks/gui-redoc-endpoint_CjSbLgG4.mjs").then(async (m)=>{
                await m.__tla;
                return m;
            }).then(async (m)=>{
                await m.__tla;
        ...
        const _page2 = ()=>import("./chunks/gui-swagger-endpoint_EUtD8ifx.mjs").then(async (m)=>{
                await m.__tla;
                return m;
            }).then(async (m)=>{
                await m.__tla;
        ...
        const _page3 = ()=>import("./chunks/index_DQ1sAf2T.mjs").then(async (m)=>{
                await m.__tla;
                return m;
            }).then(async (m)=>{
                await m.__tla;
        ...
        const _page4 = ()=>import("./chunks/index_BmeX5bH8.mjs").then(async (m)=>{
                await m.__tla;
                return m;
            }).then(async (m)=>{
                await m.__tla;
        ...
        const _page5 = ()=>import("./chunks/_gui__CUY8Y_tK.mjs").then(async (m)=>{
                await m.__tla;
                return m;
            }).then(async (m)=>{
                await m.__tla;
        ...
        const _page6 = ()=>import("./chunks/index_OkBbAQoA.mjs").then(async (m)=>{
                await m.__tla;
                return m;
            }).then(async (m)=>{
                await m.__tla;
        ...
        const _page7 = ()=>import("./chunks/_docs__CL6TMe6m.mjs").then(async (m)=>{
                await m.__tla;
                return m;
            }).then(async (m)=>{
                await m.__tla;
        ...
        const _page8 = ()=>import("./chunks/index_BapWLO9T.mjs").then(async (m)=>{
                await m.__tla;
                return m;
            }).then(async (m)=>{
                await m.__tla;
        ...
        pageMap = new Map([
            ...
            [
                "node_modules/@astro-openapi/gui-redoc/gui-redoc-endpoint.astro",
                _page1
            ],
            [
                "node_modules/@astro-openapi/gui-swagger/gui-swagger-endpoint.astro",
                _page2
            ],
            [
                "src/pages/api/v1/lylics/[id]/index.ts",
                _page3
            ],
            [
                "src/pages/api/v1/lylics/index.ts",
                _page4
            ],
            [
        ...
        const _args = {
            "middlewareSecret": "413abd1a-f9cd-4993-ac39-1b375a24ed59"
        };
